...
///   Each subcommand in sequence processed individually for every user.
/// </remarks>
public abstract class BotLongCommandHandler
{
  ...
  public virtual async Task<bool> ExecuteLongCommandStep(ITelegramBotClient telegramBotClient, Update update,
    long chatId)
  {
    var canExecute = _currentStep != null;
    if (canExecute)
      await _currentStep.StepAction(telegramBotClient, update, chatId)!;
    return canExecute;
  }
